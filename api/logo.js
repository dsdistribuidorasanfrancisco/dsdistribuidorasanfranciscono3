// api/logo.js — Tienda No.3 (template3). Devuelve el logo guardado en
// Firebase como imagen real (por si settings.logo está en base64).
// Lo usa og:image en api/home.js.

const crypto = require("crypto");

const LOGO_URL =
  "https://dsdistribuidorasfc3-default-rtdb.firebaseio.com/settings/logo.json";
